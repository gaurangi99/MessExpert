...
import com.spe.poll.payload.ChoiceResponse;
import com.spe.poll.payload.PollResponse;
import com.spe.poll.payload.UserSummary;
...
public class ModelMapper {
    public static PollResponse mapPollToPollResponse(Poll poll, Map<Long, Long> choiceVotesMap, User creator, Long userVote) {
        ...
        UserSummary creatorSummary = new UserSummary((long) creator.getId(), creator.getUsername(), creator.getName());
